...
SECRET_KEY = '6qp-it7p$ug)(po8yqwcas8i0qn(84es-=2cf@-(9zril($e@v'
...
MEDIA_ROOT = os.path.join(BASE_DIR,'media')# establecer ubicacion
...
#direccion URL al momento de logearse
...
FCM_DJANGO_SETTINGS = {
    ...
    "FCM_SERVER_KEY": "AIzaSyAWuELTCOiWJbzeX14VEkYH8PRlXp1GQB0",
